...
$lado1 = isset($_POST["lado1"]) ? (int) $_POST["lado1"] : null;
$lado2 = isset($_POST["lado2"]) ? (int) $_POST["lado2"] : null;
$lado3 = isset($_POST["lado3"]) ? (int) $_POST["lado3"] : null;
...
function classificarTriangulo($lado1, $lado2, $lado3)
{
    ...
    if (isset($lado1, $lado2, $lado3) && !empty($lado1) && !empty($lado2) && !empty($lado3)) {
        ...
        return 'Todos os campos devem ser preenchidos com valores numéricos!';
    }
}
?>
